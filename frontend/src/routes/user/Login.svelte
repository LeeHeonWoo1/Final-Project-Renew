...
import { access_token, username, is_login, user_nickname } from "../../lib/store"
...
<div id="login">
    ...
    <form method="post">
      <fieldset>
        ...
        <p><a use:link href="/find-id">아이디 찾기/</a><a use:link href="/validate" >비밀번호 찾기</a></p>
        <p><a use:link href="/sign_up">회원이 아니신가요?</a></p>
        <p><a use:link href="/">메인화면으로</a></p>
